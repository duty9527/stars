...
* [seguinleo/Notida](https://github.com/seguinleo/Notida) - A fast, private and secure web notebook with Markdown/HTML/Math support. Encrypted notes with AES-256-GCM
...
* [montanaflynn/headless-terminal](https://github.com/montanaflynn/headless-terminal) - Headless terminal — puppeteer for TUIs (vim/emacs/htop/nethack) with a Go CLI backed by libghostty-vt
...
* [grtsinry43/grtblog](https://github.com/grtsinry43/grtblog) - 不仅是博客，也是全新的内容基础设施。由 SvelteKit 与 Go 驱动，静态先行、实时交互的现代化博客系统
...
* [njcx/Artemis\_HIDS](https://github.com/njcx/Artemis_HIDS) - agent 部分使用go 开发而成，采用插件模式开发而成，配置部分以及agent存活使用etcd。
...
* [geekdex/gin-demo](https://github.com/geekdex/gin-demo) - 基于Gin+GORM框架的Restful API接口开发demo
...
* [ssnhd/giffgaff](https://github.com/ssnhd/giffgaff) -
...
* [Lenvia/job-pre](https://github.com/Lenvia/job-pre) - 【OOD 不含agent】能够覆盖校招90%后端面试的资源库
...
* [gongzisahan/sizhu-programming](https://github.com/gongzisahan/sizhu-programming) - 一本人生编程的教科书——当老天是 Python 程序员
...
* [openposter/OpenPoster](https://github.com/openposter/OpenPoster) - A collection of scripts to edit .ca files, all connected through a GUI powered by hope, dreams, and a bit of code.
...
* [Goooler/LawnchairRelease](https://github.com/Goooler/LawnchairRelease) - Easy to publish the latest Lawnchair release with my personal signing.
* [XiaoMiHongZhaJi/XposedForwardSms](https://github.com/XiaoMiHongZhaJi/XposedForwardSms) -
...
* [buttercookie42/DisableTargetAPIBlock](https://github.com/buttercookie42/DisableTargetAPIBlock) - An Xposed module for disabling Android 14's installation block for old apps
* [Tornaco/Thanox](https://github.com/Tornaco/Thanox) - I am thanos! 😈 👌
* [afeimod/linbox](https://github.com/afeimod/linbox) - 一款安卓手机用来办公娱乐的项目，利用termux和x11运行的linux系统，顺便调用mobox运行wine
